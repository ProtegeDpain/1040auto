...
//     try {
//       // Validate the data
//       const validationResult = await validateForm(subClientFormSchema, data);
...
//       await onSubmit?.(data);
//       form.reset();
//       toast.success('Sub-client form submitted successfully');
//     } catch (error) {
//       console.error('Error submitting subclient form:', error);
//       toast.error('Failed to submit sub-client form');
//     } finally {
//       setLoading(false);
//     }
//   };
